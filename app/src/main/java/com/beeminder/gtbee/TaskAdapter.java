...
public class TaskAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String title = cursor.getString(TaskDbHelper.COL_TITLE);
        viewHolder.titleView.setText(title);

        Long dueDate = cursor.getLong(TaskDbHelper.COL_DUE_DATE);
        ...
        int penalty = cursor.getInt(TaskDbHelper.COL_PENALTY);
